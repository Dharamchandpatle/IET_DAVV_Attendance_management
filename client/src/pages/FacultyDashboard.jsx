...
export function FacultyDashboard() {
  ...
  const ActiveComponent = dashboardSections.find(
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {dashboardSections.map((section, index) => (
            <motion.button
              ...
              className={`p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm dashboard-card
            ...
            >
              <div className={`w-12 h-12 rounded-lg bg-${section.color}-100 dark:bg-${section.color}-900/20 
